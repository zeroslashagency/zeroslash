        ...
        >
          ...
          {showCloseButton && (
            <DialogPrimitive.Close
              ...
              className="absolute top-4 right-4 inline-flex h-8 w-8 items-center justify-center rounded-full bg-black/10 border border-black/20 text-current opacity-90 transition-colors hover:bg-black/20 hover:opacity-100 focus:outline-none disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
              aria-label="Close"
            >
              <XIcon />
